...
namespace Talon
{
	...
	const i32 BitMaskI32 = 0xFFFFFFFF;
...
#   define TALON_GLOBALCONST extern const __attribute__((weak))
	...
	TALON_GLOBALCONST VectorInt32 VectorMaskZ = {{{ 0x00000000, 0x00000000, BitMaskI32, 0x00000000 }}};
	TALON_GLOBALCONST VectorInt32 VectorMaskW = {{{ 0x00000000, 0x00000000, 0x00000000, BitMaskI32 }}};
